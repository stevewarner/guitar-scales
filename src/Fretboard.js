...
const Fretboard = () => {
  ...
  if (canvas !== null) {
    ...
    context.rect(
      ...
      margin,
      fretboardWidth,
      fretboardHeight + fretboardHeight / 5
    );
    context.lineWidth = 3;
    context.stroke();
    // frets
    for (let i = 0; i < 5; i++) {
      ...
      context.lineTo(
        fretboardWidth + margin,
        margin + (fretboardHeight / 5) * (i + 1)
      );
      context.stroke();
    }
    ...
    for (let i = 0; i < 4; i++) {
      ...
      context.lineTo(
        margin + (fretboardWidth / 5) * (i + 1),
        fretboardHeight + margin + fretboardHeight / 5
      );
      context.stroke();
    }
    ...
    context.fillText(
      "1",
      margin - 40,
      margin + (fretboardHeight / 5) * 2 - fretboardHeight / 5
    );

    context.fillText(
      "2",
      margin - 40,
      margin + (fretboardHeight / 5) * 3 - fretboardHeight / 5 / 2
    );
    context.fillText(
      "3",
      margin - 40,
      margin + (fretboardHeight / 5) * 4 - fretboardHeight / 5 / 2
    );
